  ...
  return (
    ...
    >
      ...
      <p className="text-base lg:text-lg text-gray-700 leading-relaxed mb-8 w-full lg:max-w-1/2">
        Our lab goes beyond research—sponsoring events like{" "}
        <strong>OwlHacks</strong>, where students collaborate, create, and
        connect with alumni and industry professionals to bring human-centered
        ideas to life.
      </p>
