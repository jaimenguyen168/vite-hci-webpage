...
export function ResearchCard({ research }: ResearchCardProps) {
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      {/* Image */}
      <div className={`w-full ${DESIGN_TOKENS.spacing.cardImageHeight} overflow-hidden`}>
        <img 
          src={research.image} 
          alt={research.title}
      ...
      <div className="p-4">
        {/* Title */}
        <div className="mb-3">
          <h4 className="font-semibold text-gray-900 text-base leading-tight">{research.title}</h4>
        </div>
        
        {/* Description */}
        <p className="text-gray-600 text-sm mb-4 leading-relaxed">{research.description}</p>
