    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start font-roboto">
        <div className="w-full">
          <Title title="Owl Hacks" />

          <p className="mt-4">
            Our HCI Lab at Temple proudly sponsors OwlHacks, the university’s
            annual hackathon that brings together creative students from all
            disciplines to design, build, and innovate.
            <br />
            <br />
            Through this event, we celebrate collaboration, accessibility, and
            the spirit of human-centered design—empowering students to turn
            ideas into impactful, user-focused technologies.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start font-roboto py-10">
        ...
        <div>
          ...
          <p className="mt-4">
            OwlHacks features panels with Temple alumni now working in the tech
